...
Method 3: Shift out of Fear/Anger
...
Look at the injury that it causes to others.


Reach out to those people and discover what really matters to them.  Then think of ways to help them achieve that. 
...
Soon, department heads started presenting this information proactively for Marquet before he even asked.  Because of this, each department head started thinking like a commander (assessing how each decision would affect all the departments and not just their own).
...
Method 7: Difficult Conversation
...
Method 8: Make People Feel Heard
...
Method 9: Bias to Action

Frank Slootman's "Bias to Action" (from Amp It Up)
In meetings, team members often commit to deadlines like: "I'll do this by next week."
Slootman's challenge: "Why can't you get it done by tomorrow?"
Core Idea: Speeding up actions accelerates the entire company's momentum.
Taking It One Step Further: "Why Not Right Now?"
Problem: The hardest part of any task is starting.
Solution: Begin the first two minutes of every agreed-upon action during the meeting.
Tactic: Reserve the last 10 minutes of every meeting to initiate action steps.
Two Types of Actions and How to Handle Them
Actions You Can Do Yourself
If it takes less than 2 minutes: Do it immediately.
If it takes more than 2 minutes:
Estimate the time required.
Create a calendar event with the action as the title (e.g., "Write client proposal – 30 mins").
Actions That Involve Someone Else
Option 1: Existing Scheduled Meeting
If you already have a meeting scheduled with them:
Add the action item to the meeting agenda.
Tip: Maintain a notes section listing people you regularly meet with, listing discussion points under their names.
Option 2: No Upcoming Meeting
If informing them takes less than 2 minutes: Send the message immediately.
If it takes more than 2 minutes:
Estimate the time (e.g., 15 minutes for a detailed email).
Block that time on your calendar to complete the task.
Why This Method Works
Immediate Momentum: Starting makes follow-through easier.
Snowball Effect: Small beginnings lead to self-sustaining progress.
Faster Execution: Tasks move forward without delay.
Bottom Line
At the end of every meeting:
Do it now – if it's quick (<2 minutes).
Schedule time – if it's longer (>2 minutes).
Add to agenda – if you'll discuss it in an upcoming meeting.
Message now or schedule messaging time – if it involves others.
This bias toward immediate action ensures faster execution, natural momentum, and improved productivity.
